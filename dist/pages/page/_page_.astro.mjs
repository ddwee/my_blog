...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const totalPages = Math.ceil(articleIds.length / articlesPerPage);
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "\u79C1\u306E\u65E5\u8A18" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${maybeRenderHead()}<div class="container"> ${renderComponent($$result2, "Sidebar", $$Sidebar, {})} <div class="main-content"> <main id="content"> ${articles.map((article) => renderTemplate`${renderComponent($$result2, "ArticleCard", $$ArticleCard, { "article": article, "filterType": "", "filterValue": "" })}`)} </main> ${totalPages > 1 && renderTemplate`${renderComponent($$result2, "Pagination", $$Pagination, { "currentPage": currentPage, "totalPages": totalPages, "baseUrl": "/page/" })}`} </div> </div> ` })}`;
}, "D:/blog/src/pages/page/[page].astro", void 0);

const $$file = "D:/blog/src/pages/page/[page].astro";
const $$url = "/page/[page]";
